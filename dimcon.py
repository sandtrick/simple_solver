...
acceleration = {'m/s^2': 1, 'in/s^2': 0.0254,
 'ft/s^2': 0.3048, 'km/s^2': 1000, 'mm/s^2': 0.001}

# Angle Base: radians
angle = {'radians': 1, 'degrees': 0.017453292519943}

# Area Base: m^2
area = {'m^2': 1, 'mile^2': 2589975.2356, 'yard^2': 0.836127,
 'ft^2': 0.092903, 'in^2': 0.000645, 'Mm^2': 10**12,
 'km^2': 10**6, 'cm^2': 10**-4, 'mm^2': 10**-6,
 'um^2': 10**-12, 'nm^2': 10**-18, 'pm^2': 10**-24}

# Energy Base: J
energy = {'J': 1, 'N-m': 1, 'Btu': 1055.05585, 'cal': 4.18400,
...
# Force Base: N
force = {'N': 1, 'klbf': 4448.22162, 'lbf': 4.44822162,
 'MN': 10**6, 'kN': 1000, 'mN': 0.001, 'uN': 10**-6}

# Length Base: m
length = {'m':1 , 'mile': 1609.344, 'yard': 0.9144,
 'ft': 0.3048, 'in': 0.0254, 'Mm': 10**6, 'km': 10**3,
 'cm': 0.01, 'mm': 10**-3, 'um': 10**-6, 'nm': 10**-9,
 'pm': 10**-12}

# Mass Base: kg
mass = {'kg': 1, 'klbm': 453.592, 'lbm': 0.453592,
 'slugs': 14.5939029, 'Mg': 1000, 'g': 10**-3,
 'mg': 10**-6, 'ug': 10**-9}

# Pressure Base: N/m^2
pressure = {'N/m^2': 1, 'TN/m^2': 10**12, 'GN/m^2': 10**9,
